...
<div class='row'>
    <div class='col-md-12'>
        ...
        <div class="box box-primary">
            ...
            <div class="box-body">
                <form action="{{ route('add_meal') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group has-feedback {{ $errors->has('meal_id') ? 'has-error' : '' }}">
                                <label>Meal ID</label>
                                <input type="text" name="meal_id" id="meal_id" class="form-control" readonly value="{{ $meal_id }}">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group has-feedback {{ $errors->has('unit_price') ? 'has-error' : '' }}">
                                <label>Unit Price/LKR</label>
                                <input type="text" name="unit_price" id="unit_price" class="form-control" placeholder="Unit Price" value="{{ old('unit_price') }}" required>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group has-feedback {{ $errors->has('name') ? 'has-error' : '' }}">
                                ...
                                <input type="text" name="name" id="name" class="form-control" placeholder="Meal Name" value="{{ old('name') }}" required>
                                @if($errors->has('name'))
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group has-feedback {{ $errors->has('description') ? 'has-error' : '' }}">
                                ...
                                <textarea class="form-control" rows="2" placeholder="Description" id="description" name="description">{{ old('description') }}</textarea>
